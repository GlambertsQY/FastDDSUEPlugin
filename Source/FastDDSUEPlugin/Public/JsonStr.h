...
#ifndef _FAST_DDS_GENERATED_FASTDDSJSONSTR_H_
#define _FAST_DDS_GENERATED_FASTDDSJSONSTR_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(FASTDDSJSONSTR_SOURCE)
#define FASTDDSJSONSTR_DllAPI __declspec( dllexport )
#else
#define FASTDDSJSONSTR_DllAPI __declspec( dllimport )
#endif // FASTDDSJSONSTR_SOURCE
#else
#define FASTDDSJSONSTR_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define FASTDDSJSONSTR_DllAPI
#endif // _WIN32
...
public:
     ...
     * @param x Reference to the object JsonStrBean that will be copied.
     */
    eProsima_user_DllExport JsonStrBean(
            const JsonStrBean& x);
     ...
     * @param x JsonStrBean object to compare.
     */
     ...
     */
    eProsima_user_DllExport void JsonString(
     ...
     */
    eProsima_user_DllExport const std::string& JsonString() const;

    /*!
     * @brief This function returns a reference to member JsonString
     * @return Reference to member JsonString
     */
    eProsima_user_DllExport std::string& JsonString();
...
#endif // _FAST_DDS_GENERATED_FASTDDSJSONSTR_H_
